...
from src.extractors.page_ocr import extract_pages_ocr
...
def run(pdf_path: str, output: str | None, lang: str, verbose: bool) -> DocumentResult:
    """
    ...
    pages_data = extract_pages_ocr(pdf_path, lang=lang, verbose=verbose)
    ...
    for page_number, blocks, (img_width, img_height) in pages_data:
        ...
        # Adiciona imagens embutidas desta página
